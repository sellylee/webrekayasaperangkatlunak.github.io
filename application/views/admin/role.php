...
<!-- alert form error -->
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $r['role']; ?></td>
      <td>
      <a href="<?= base_url('admin/roleaccess/') . $r['id']; ?>" class="">
      <img src="https://img.icons8.com/dusk/30/000000/details-pane.png"/></a>

     <!-- hapus -->
      <a href="<?= base_url('admin/hapusRole/') . $r['id']; ?>" class="tombol-hapus">
